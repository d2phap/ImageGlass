namespace ImageGlass.UI
{
    partial class ModernColorPicker
    {
        ...
        private void InitializeComponent()
        {
            ...
            TableColorViews = new TableLayoutPanel();
            ViewOldColor = new ColorView();
            ViewNewColor = new ColorView();
            ...
            SliderRgb.Location = new Point(828, 0);
            ...
            SliderAlpha.Location = new Point(948, 0);
            ...
            // TableColorViews
            // 
            TableColorViews.ColumnCount = 2;
            TableLayout.SetColumnSpan(TableColorViews, 3);
            TableColorViews.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
            TableColorViews.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 50F));
            TableColorViews.Controls.Add(ViewOldColor, 0, 0);
            TableColorViews.Controls.Add(ViewNewColor, 0, 0);
            TableColorViews.Dock = DockStyle.Left;
            TableColorViews.Location = new Point(1068, 10);
            TableColorViews.Margin = new Padding(10, 10, 10, 40);
            TableColorViews.Name = "TableColorViews";
            TableColorViews.RowCount = 1;
            TableColorViews.RowStyles.Add(new RowStyle(SizeType.Percent, 100F));
            TableColorViews.Size = new Size(315, 80);
            TableColorViews.TabIndex = 3;
            // 
            // ViewOldColor
            // 
            ViewOldColor.ColorValue = Color.Empty;
            ViewOldColor.DarkMode = false;
            ViewOldColor.Dock = DockStyle.Fill;
            ViewOldColor.Location = new Point(157, 0);
            ViewOldColor.Margin = new Padding(0);
            ViewOldColor.Name = "ViewOldColor";
            ViewOldColor.Size = new Size(158, 80);
            ViewOldColor.TabIndex = 0;
            ViewOldColor.TabStop = false;
            ViewOldColor.Text = "colorView4";
            // 
            // ViewNewColor
            // 
            ViewNewColor.ColorValue = Color.FromArgb(100, 50, 100, 100);
            ViewNewColor.DarkMode = false;
            ViewNewColor.Dock = DockStyle.Fill;
            ViewNewColor.Location = new Point(0, 0);
            ViewNewColor.Margin = new Padding(0);
            ViewNewColor.Name = "ViewNewColor";
            ViewNewColor.Size = new Size(157, 80);
            ViewNewColor.TabIndex = 0;
            ViewNewColor.TabStop = false;
            ViewNewColor.Text = "colorView3";
            // 
            // modernLabel9
            // 
            ...
            TableColorViews.ResumeLayout(false);
            ResumeLayout(false);
        }
        ...
        private TableLayoutPanel TableColorViews;
        private ColorView ViewOldColor;
        private ColorView ViewNewColor;
